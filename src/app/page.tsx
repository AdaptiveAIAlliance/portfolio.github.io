...
export default function Home() {
  ...
  return (
    <>
      <ThreeFiberScene />
      <Header />
      <main className="flex text-neutral-900 min-h-screen   dark:text-emerald-100 flex-col justify-center items-center sm:px-24 px-8  ">
        <h1
        ...
        >
              ...
              >
                <Card className=" py-4 backdrop-filter backdrop-blur-xl bg-slate-200 dark:bg-emerald-900 bg-opacity-40 dark:bg-opacity-40 dark:bg-emerald-800/40">
                  <CardHeader className="">
                    <CardTitle className=" leading-8">{skill.title}</CardTitle>
                  </CardHeader>
          ...
          <CarouselPrevious className="animate-pulse dark:bg-emerald-100/60 fixed m-auto top-[15vh] right-[10vw] translate-x-0 left-auto" />
          <CarouselNext className="animate-pulse dark:bg-emerald-100/60 fixed m-auto bottom-[15vh] right-[10vw] translate-x-0 left-auto" />
        </Carousel>
      </main>
    </>
  );
